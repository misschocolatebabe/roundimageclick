package com.bigkidsapps.roundimageclick;
...
public class RoundImageClick extends ImageView {
	...
	public interface onCircularClickListener {
		void onCircularButtonClick(View v);
	}
	...
	public RoundImageClick(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public RoundImageClick(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public RoundImageClick(Context context, AttributeSet attrs, int defStyle) {
